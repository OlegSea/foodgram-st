# Generated by Django 5.2.8 on 2025-12-15 16:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Обязательное поле. Не более 150 символов. Только буквы, цифры и символы @/./+/-/_.', max_length=150, unique=True, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+$', 'Введите корректный псевдоним пользователя.')], verbose_name='Псевдоним')),
                ...
                ('avatar', models.ImageField(blank=True, help_text='Загрузите аватар пользователя', null=True, upload_to='users/avatars/', verbose_name='Аватар')),
